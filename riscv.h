...
#ifdef CR116
#define CR116_UART_CTRL_ADDR _AC(0x0080010000000000,UL) 
#define UART_BASE CR116_UART_CTRL_ADDR
#else /* CR3664 */
#define UARTF_CTRL_ADDR _AC(0x00A3EE4000000010,UL)
#define UART0_CTRL_ADDR _AC(0x00A3EE4000000000,UL)
